...
export default function EditDialog({ openEditDialog, editedName, editedShortUrl, link, setEditedName, setEditedShortUrl, handleEditDialogClose, handleEditSave }: DialogsProps) {
  return (
    <Dialog open={openEditDialog} onClose={handleEditDialogClose}>
      ...
      <DialogContent>
        ...
        <TextField
          ...
          InputProps={{
          startAdornment: <InputAdornment position="start">{link?.shortUrl.split("/")[0]}/</InputAdornment>,
